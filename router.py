...
def load_models() -> dict:
    # Phase 39 — brain transplant: hf.co/ornith-ai/Ornith-1.5-35B-A3B-GGUF:Q4_K_M owns heavy/code/design
    # and the route classifier; qwen3:4b stays as the fast tier.
    if not MODELS_FILE.exists():
        return {
            "brain": "hf.co/ornith-ai/Ornith-1.5-35B-A3B-GGUF:Q4_K_M",
            "router": "hf.co/ornith-ai/Ornith-1.5-35B-A3B-GGUF:Q4_K_M",
            "fast": "qwen3:4b",
            "mid": "qwen3:8b",
            "heavy": "hf.co/ornith-ai/Ornith-1.5-35B-A3B-GGUF:Q4_K_M",
            "code": "hf.co/ornith-ai/Ornith-1.5-35B-A3B-GGUF:Q4_K_M",
            "design": "hf.co/ornith-ai/Ornith-1.5-35B-A3B-GGUF:Q4_K_M",
        }
    try:
...
def model_for(route: str) -> str:
    ...
    models = load_models()
    return models.get(route) or models.get("heavy") or "hf.co/ornith-ai/Ornith-1.5-35B-A3B-GGUF:Q4_K_M"


def _router_model() -> str:
    return load_models().get("router", "hf.co/ornith-ai/Ornith-1.5-35B-A3B-GGUF:Q4_K_M")
